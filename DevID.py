#!/usr/bin/python2
# Iqbal Dev Recode By
# Yumasaa, Hikmat, Ramdhan-R,Yogs, Eza
d = "\033[90;1m"
m = "\033[91;1m"
h = "\033[92;1m"
k = "\033[93;1m"
...
def __seting_ua_dev__():
	print garis
	print k+"\n   *"+p+" Setting User-Agent Biar One Tap Tod"
	print k+"   ?"+h+" Pilih User-Agent Sesuai Handphone?"
	print garis
	...
	print h+" ["+p+"8"+h+"]"+p+" Masukkan User-Agent Manual Jika Ingin One Tapp"
	print garis
	pil = raw_input(a+" [?]"+p+" Pilih? "+k)

	sukses = p+"\n >_<"+h+" Sukses Setting User-Agent, Moga One Tapp Crott"
		...
		with requests.Session() as ses_:
			...
			try:
				if user_agent_ == cokiez: 
					...
					print h+" ["+k+"*"+h+"]"+p+" Status:"+h+"Limited/Trial/Demo"
			except NameError:
